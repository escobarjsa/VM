        ...
        <tbody>
            ...
            ?>
                    ...
                    <tr>
                        ...
                        <td><?php echo "<span class='fas " . ($s->getEstadoSolicitud() == 0 ? "fa-times-circle text-danger" : "fa-check-circle text-success") . "' data-toggle='tooltip' class='tooltipLink' data-placement='left' data-original-title='" . ($s->getEstadoSolicitud() == 0 ? "Sin Asignar" : "Asignado") . "' ></span>"; ?>
                        </td>
                    </tr>
                    <tr>
