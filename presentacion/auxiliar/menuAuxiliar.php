        ...
        <div class="card">
            <div class="card-body">
                ...
                <aside class="menu">
                    ...
                    <ul class="menu-list">
                        <li><a href=<?php echo "index.php?pid=" . base64_encode("presentacion/mascota/solicitudesLimpieza.php") ?>>Solicitudes
                                En Espera</a></li>
                        <li><a href=<?php echo "index.php?pid=" . base64_encode("presentacion/auxiliar/historialSolicitudes.php") . "&who=c&idCliente=" . $_SESSION['id'] ?>>Historial
                                De Solicitudes</a></li>
                    </ul>
                </aside>
            </div>
