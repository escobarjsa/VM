                ...
                <div class="card-body">
                    ...
                    ?>
                        <div class="alert alert-success" role="alert">Veterinario actualizado
                            exitosamente.</div>
                    <?php } ?>
                    <form action=<?php echo "index.php?pid=" . base64_encode("presentacion/veterinario/actualizarVeterinario.php") . "&idVeterinario=" . $_GET["idVeterinario"] ?> method="post">
                        <div class="form-group">
                            <input type="text" name="nombre" class="form-control" placeholder="Nombre" required="required" value="<?php echo $veterinario->getNombre(); ?>">
                        </div>
                        <div class="form-group">
                            <input type="text" name="apellido" class="form-control" placeholder="apellido" required="required" value="<?php echo $veterinario->getApellido(); ?>">
                        </div>
                        <div class="form-group">
