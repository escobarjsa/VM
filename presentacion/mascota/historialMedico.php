					...
					<form action=<?php echo "index.php?pid=" . base64_encode("presentacion/mascota/historialMedico.php") . "&idSolicitud=" . $_GET["idSolicitud"] ?> method="post">
						...
						<?php if ($veterinario->getEspecialidad() == "General") { ?>
							<div class="field is-horizontal">
								...
								<div class="field-body">
									<div class="field">
										<div class="control">
											<textarea class="textarea" name="diagnostico" required="required" placeholder="Diagnostico De La Mascota"></textarea>
										</div>
									</div>
								</div>
							</div>
						...
						<?php } else { ?>
							<div class="field is-horizontal">
								...
								<div class="field-body">
									<div class="field">
										<div class="control">
											<textarea class="textarea" name="tratamiento" required="required" placeholder="Tratamiento De La Mascota"></textarea>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="field is-horizontal">
							...
							<div class="field-body">
								<div class="field">
									<div class="control">
										<input class="input" type="text" required="required" name="observacion" placeholder="Observaciones Del Tratamiento O Diagnostico">
									</div>
								</div>
							</div>
						</div>
