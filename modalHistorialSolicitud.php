    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo "<span class='fas " . ($solicitud->getEstadoSolicitud() == 0 ? "fa-times-circle text-danger" : "fa-check-circle text-success") . "' data-toggle='tooltip' class='tooltipLink' data-placement='left' data-original-title='" . ($solicitud->getEstadoSolicitud() == 0 ? "Sin Asignar" : "Asignado") . "' ></span>"; ?>
                </td>
            </tr>
            <tr>
                <th width="30%">Estado Proceso</th>
                <td><?php echo "<span class='fas " . ($solicitud->getEstadoProceso() == 0 ? "fa-times-circle text-danger" : "fa-check-circle text-success") . "' data-toggle='tooltip' class='tooltipLink' data-placement='left' data-original-title='" . ($solicitud->getEstadoProceso() == 0 ? "Sin Realizar" : "Realizado") . "' ></span>"; ?>
                </td>
            </tr>

            <tr>
                <th width="30%">Estado Facturacion</th>
                <td><?php echo "<span class='fas " . ($solicitud->getFactura() == "" ? "fa-times-circle text-danger" : "fa-check-circle text-success") . "' data-toggle='tooltip' class='tooltipLink' data-placement='left' data-original-title='" . ($solicitud->getFactura() == "" ? "Sin Facturar" : "Facturado") . "' ></span>"; ?>
                </td>
            </tr>
            <tr>
