    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo "<span class='fas " . ($solicit->getEstadoProceso() == 0 ? "fa-times-circle text-danger" : "fa-check-circle text-success") . "' data-toggle='tooltip' class='tooltipLink' data-placement='left' data-original-title='" . ($solicit->getEstadoSolicitud() == 0 ? "Sin Realizar" : "Realizado") . "' ></span>"; ?>
                </td>
            </tr>
            <tr>
                <th width="30%">Estado Facturacion</th>
                <td><?php echo "<span class='fas " . ($solicit->getFactura() == "" ? "fa-times-circle text-danger" : "fa-check-circle text-success") . "' data-toggle='tooltip' class='tooltipLink' data-placement='left' data-original-title='" . ($solicit->getFactura() == "" ? "Sin Facturar" : "Facturado") . "' ></span>"; ?>
                </td>
            </tr>
            <tr>
